...
import { hydrateDashboard } from 'src/dashboard_embed/actions/hydrate';
import { setDatasources } from 'src/dashboard_embed/actions/datasources';
...
import { canUserEditDashboard } from 'src/dashboard_embed/util/findPermission';
import DashboardContainer from 'src/dashboard_embed/containers/Dashboard';
...
const DashboardPage: FC<IDashboardPage> = props => {
