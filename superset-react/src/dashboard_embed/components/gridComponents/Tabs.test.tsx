...
import { nativeFiltersInfo } from 'src/dashboard_embed/fixtures/mockNativeFilters';
...
import emptyDashboardLayout from 'src/dashboard_embed/fixtures/emptyDashboardLayout';
import { Tabs } from './Tabs';

jest.mock('src/dashboard_embed/containers/DashboardComponent', () =>
  jest.fn(props => (
    <button
      type="button"
      onClick={() =>
...
jest.mock('src/dashboard_embed/components/DeleteComponentButton', () =>
  jest.fn(props => (
    <button
      type="button"
