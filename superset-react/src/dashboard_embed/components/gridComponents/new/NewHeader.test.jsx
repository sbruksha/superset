...
import NewHeader from 'src/dashboard_embed/components/gridComponents/new/NewHeader';

import { NEW_HEADER_ID } from 'src/dashboard_embed/util/constants';
import { HEADER_TYPE } from 'src/dashboard_embed/util/componentTypes';
