...
import NewTabs from 'src/dashboard_embed/components/gridComponents/new/NewTabs';

import { NEW_TABS_ID } from 'src/dashboard_embed/util/constants';
import { TABS_TYPE } from 'src/dashboard_embed/util/componentTypes';
