...
import NewDivider from 'src/dashboard_embed/components/gridComponents/new/NewDivider';

import { NEW_DIVIDER_ID } from 'src/dashboard_embed/util/constants';
import { DIVIDER_TYPE } from 'src/dashboard_embed/util/componentTypes';
